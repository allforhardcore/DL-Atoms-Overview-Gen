async function main() {
  ...
  for (const page of figma.root.children) {
    ...
    if (componentSets.length > 0) {
      ...
      cardList.primaryAxisSizingMode = 'FIXED'; // Ширина будет задана размером родителя
      cardList.counterAxisSizingMode = 'AUTO'; // Высота будет автоматической
      ...
      // Позиционируем ширину cardList как fill, относительно ширины pageContainer
